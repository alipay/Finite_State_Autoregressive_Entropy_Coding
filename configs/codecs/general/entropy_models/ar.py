...
from cbench.modules.entropy_coder.autoregressive import AutoregressiveEntropyCoder
...
config = import_class_builder_from_module(base_module).update_class(AutoregressiveEntropyCoder)\
